    ...
    try:
        ...
        try:
            with open(baseline_1_path, 'r') as f1, \
                ...
                # print("----------------------------")
                # print("baseline_1_content==>",baseline_1_content)
                # print("baseline_1_content==>",baseline_1_content)
                # print("teacher_content",teacher_content)
                # print("----------------------------")
...
#         file_path = r'E:\2025\Team\upwork\prufia\TrueWrite_MVP_CODES\backend\baselines\9\6d6ca408-8291.txt'
...
#         # 3. Read with multiple encoding fallbacks
